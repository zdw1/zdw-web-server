<style scoped>
    ...
    .wrap_conter li{list-style-type:none; text-align:center;color:#fff;font-size:12px;line-height:30px; padding:0 25px 5px 25px;width: 100%;}
                        ...
                        <li>
                            ...
                            <dl>
                                ...
                                <FormItem prop="password">
                                    ...
                                    <Icon type="ios-navigate-outline" slot="prepend"></Icon></Input>
                                </FormItem>
                                <FormItem>
